    ...
    <div className="min-h-screen flex items-center justify-center bg-page">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="flex flex-col items-center gap-3 mb-3">
            {logoUrl && !logoFailed ? (
              ...
              <div className="w-28 h-28 rounded-2xl bg-primary flex items-center justify-center shrink-0">
            ...
            <span className="text-2xl font-bold text-heading tracking-tight">{platformName}</span>
          </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-border p-8">
          ...
          {mode === "login" ? (
            <>
              <h2 className="text-lg font-semibold text-heading mb-6">Sign in to your account</h2>
              ...
              <form onSubmit={handleLogin} className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 rounded-lg border-2 border-accent text-heading text-sm placeholder:text-muted focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition"
                  />
                </div>
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full py-2.5 px-4 bg-primary hover:bg-primary-dark disabled:opacity-60 text-white text-sm font-medium rounded-lg transition"
                >
            ...
            <>
              <div className="text-center py-2">
                ...
                <h2 className="text-lg font-semibold text-heading mb-2">Check your email</h2>
                <p className="text-sm text-secondary mb-1">
                  We sent a password reset link to
                </p>
                <p className="text-sm font-medium text-heading mb-6">{resetEmail}</p>
            ...
            <>
              <button
                ...
                className="flex items-center gap-1 text-xs text-secondary hover:text-heading mb-5"
              >
              ...
              <h2 className="text-lg font-semibold text-heading mb-1">Reset your password</h2>
        ...
        {supportEmail && (
          <p className="text-center text-xs text-secondary mt-6">
            Need help? Contact <a href={`mailto:${supportEmail}`} className="text-accent hover:underline">{supportEmail}</a>
          </p>
        )}
        {!supportEmail && (
          <p className="text-center text-xs text-secondary mt-6">
