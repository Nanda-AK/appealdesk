...
export default function SpError({
  ...
  useEffect(() => {
    // Log to the browser console so it's visible during local dev
    console.error("[SP page error]", error);
  }, [error]);

  return (
    <div className="p-8 flex items-center justify-center min-h-[60vh]">
      <div className="bg-white border border-border rounded-xl shadow-sm px-8 py-10 max-w-md w-full text-center">
