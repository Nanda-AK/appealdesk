    ...
    <>
      ...
      <div ref={wrapperRef} className="relative inline-flex">
        ...
        <button
          ...
          className="inline-flex items-center gap-2 px-4 py-2.5 bg-[#1E3A5F] hover:bg-[#162d4a] text-white text-sm font-medium rounded-l-lg transition"
        >
        ...
        <button
          ...
          className="px-2.5 py-2.5 bg-[#1E3A5F] hover:bg-[#162d4a] text-white rounded-r-lg border-l border-white/30 transition"
