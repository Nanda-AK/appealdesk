    ...
    <div>
      ...
      <div className="flex items-center gap-0.5">
        ...
        <label title={value ? "Replace attachment" : "Upload attachment"}
          className={`cursor-pointer p-1.5 rounded hover:bg-[#F3F4F6] transition-colors text-[#6B7280] hover:text-[#1A1A2E] inline-flex ${uploading ? "opacity-50 pointer-events-none" : ""}`}>
          {uploading
