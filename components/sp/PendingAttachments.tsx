  ...
  return (
    <div className="border border-border rounded-lg overflow-hidden">
      ...
      <div className="px-4 py-2 bg-page flex items-center justify-between border-b border-border">
        <span className="text-xs font-semibold text-secondary uppercase tracking-wide">Attachments ({files.length})</span>
        ...
        <div className="border-t border-border bg-page px-4 py-3 space-y-3">
          ...
          <div className="flex gap-2 pt-1">
            <button type="button" onClick={attachAll}
              className="px-3 py-1 text-xs bg-primary hover:bg-primary-dark text-white rounded-lg font-medium">
